...
class _ClientesHomeState extends State<ClientesHome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text("¡Bienvenide, ${widget.usuario.nombreCompleto()}!")),
      body: Center(
        child: Column(
          children: <Widget>[
            Padding(
                    ...
                    children: [
                      Ink(
                        ...
                        child: IconButton(
                            ...
                            color: Colors.white,
                            onPressed: () async {
                              api = ApiClient(widget.usuario.email,
                                  widget.usuario.password);
                              Future<bool> isLocationServiceEnabled = this.isServiceEnabledAndPermissionGranted(_location);
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (BuildContext context) =>
  ...
  void onConceptoMarkerTap(markerId, model.Concepto concepto,
      [String text]) async {
    await showDialog(
      context: context,
          ...
          FlatButton(
            onPressed: () {
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (BuildContext context) =>
                          ConfirmarNuevoTurno(widget.usuario, concepto)));
            },
  ...
  Future<bool> isServiceEnabledAndPermissionGranted(Location location) async {
    bool _serviceEnabled;
    print("Veryfing if location service is enabled...");
    ...
    print("Veryfing location permissions...");
